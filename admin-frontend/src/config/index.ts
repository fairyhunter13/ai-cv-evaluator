...
export const config = {
  ...
  autoRefreshInterval: parseInt((import.meta as any).env?.VITE_AUTO_REFRESH_INTERVAL || '5000', 10),
  
  // Application Configuration
  appName: (import.meta as any).env?.VITE_APP_NAME || 'AI CV Evaluator Admin',
