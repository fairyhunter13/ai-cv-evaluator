...
func (_mock *MockBeginner) Begin(ctx context.Context) (Tx, error) {
...
//   - ctx context.Context
func (_e *MockBeginner_Expecter) Begin(ctx interface{}) *MockBeginner_Begin_Call {
	return &MockBeginner_Begin_Call{Call: _e.mock.On("Begin", ctx)}
}

func (_c *MockBeginner_Begin_Call) Run(run func(ctx context.Context)) *MockBeginner_Begin_Call {
...
func (_c *MockBeginner_Begin_Call) Return(tx Tx, err error) *MockBeginner_Begin_Call {
	_c.Call.Return(tx, err)
	return _c
}

func (_c *MockBeginner_Begin_Call) RunAndReturn(run func(ctx context.Context) (Tx, error)) *MockBeginner_Begin_Call {
	_c.Call.Return(run)
	return _c
}
