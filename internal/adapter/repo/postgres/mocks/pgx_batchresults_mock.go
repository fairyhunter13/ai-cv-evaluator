...
// Close provides a mock function for the type MockBatchResults
func (_mock *MockBatchResults) Close() error {
	ret := _mock.Called()
...
func (_c *MockBatchResults_Close_Call) Return(err error) *MockBatchResults_Close_Call {
	_c.Call.Return(err)
	return _c
}
...
// Exec provides a mock function for the type MockBatchResults
func (_mock *MockBatchResults) Exec() (pgconn.CommandTag, error) {
	ret := _mock.Called()
...
func (_c *MockBatchResults_Exec_Call) Return(commandTag pgconn.CommandTag, err error) *MockBatchResults_Exec_Call {
...
// Query provides a mock function for the type MockBatchResults
func (_mock *MockBatchResults) Query() (pgx.Rows, error) {
	ret := _mock.Called()
...
func (_c *MockBatchResults_Query_Call) Return(rows pgx.Rows, err error) *MockBatchResults_Query_Call {
...
// QueryRow provides a mock function for the type MockBatchResults
func (_mock *MockBatchResults) QueryRow() pgx.Row {
	ret := _mock.Called()
...
func (_c *MockBatchResults_QueryRow_Call) Return(row pgx.Row) *MockBatchResults_QueryRow_Call {
	_c.Call.Return(row)
	return _c
}
