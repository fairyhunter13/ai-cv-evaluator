...
// ScanRow provides a mock function for the type MockRowScanner
func (_mock *MockRowScanner) ScanRow(rows pgx.Rows) error {
...
func (_c *MockRowScanner_ScanRow_Call) Return(err error) *MockRowScanner_ScanRow_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockRowScanner_ScanRow_Call) RunAndReturn(run func(rows pgx.Rows) error) *MockRowScanner_ScanRow_Call {
	_c.Call.Return(run)
	return _c
}
